...
/*
    information on customer a resturant would need:
    - billing info to charge their meal
    - table position in resturant
    - order of food
    - name to identify
*/
...
*/
 ...
 customer = {
    billingInfo : 'Credit Card Number',
    tablePosition : 'Northeast Window Booth',
